...
usage       'autocompile-sprockets [options]'
summary     'start the autocompiler with sprockets'
aliases     :aco
description <<-EOS
Start the autocompiler web server with sprockets. Unless specified, the web server will run
...
module Nanoc::CLI::Commands
  ...
  class AutoCompileSprockets < ::Nanoc::CLI::CommandRunner
...
runner Nanoc::CLI::Commands::AutoCompileSprockets
